        ...
        {currentUser ? (
          ...
          >
            ...
            <Link to={'/dashboard?tab=profile'}>
              <Dropdown.Item>Profile <FaUser className='text-teal-500 m-1' /></Dropdown.Item>
            </Link>
            <Dropdown.Divider />
            <Dropdown.Item onClick={handleSignout}>Sign out <FaSignOutAlt className='text-teal-500 m-1' /></Dropdown.Item>
          </Dropdown>
        ) : (
          <Link to='/sign-in'>
